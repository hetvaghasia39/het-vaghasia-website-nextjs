...
export default function MyName() {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a <span className="text-AAsecondary">software engineer</span>, who loves using web technologies 
        to create exceptional products. <br className="2xl:block hidden" />
        My main focus is on using technology to tackle 
        challenges in various niches and industries. <br className="2xl:block hidden"/>
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        ...
        className="mt-12"
      >
        <a href={"https://docs.google.com/document/d/1s8eJkDQfwZLJWTbcRQUsS_LbLmwzA42e_5H6mrXl2mY/edit"} target={"_blank"} rel="noreferrer">
