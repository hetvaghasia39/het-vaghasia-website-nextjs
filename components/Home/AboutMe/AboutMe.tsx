...
export default function AboutMe(props) {
  const technologies = [
    ["Python", "Django", "Flask", "Next.js", "SQL", "AWS"],
    ["JavaScript", "FastAPI", "React.js", "Docker", "CI/CD"],
  ];
  return (
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Het, and I am a passionate software engineer and problem solver, dedicated to
                creating impactful codes that thrive on the internet. My journey in computer science began in 2018 when
                I delved into the world of Web development using Python. Little did I know that programming skills
            ...
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                refine my expertise in web development, data science, clouds, and devops. I am dedicated to pushing boundaries and driving
                advancements. With experience working alongside esteemed organizations like{" "}
                <span className="text-AAsecondary">PragetX</span>, where I played a key role in leading and releasing many projects{" "}
